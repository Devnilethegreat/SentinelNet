# SentinelNet: Network-level blockchain threat detection and node anomaly monitoring Implementation
> Advanced python solution leveraging modern architecture patterns and cutting-edge AI technology.

SentinelNet analyses P2P network topology and gossip propagation patterns to identify eclipse attacks, Sybil clusters, and other network-level threats using graph neural networks.

SentinelNet's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/SentinelNet.git
cd SentinelNet
```
...
- **2026-04-13** — Expand test coverage for edge cases
